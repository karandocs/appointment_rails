...
class DoctorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doctor" do
    assert_difference('Doctor.count') do
      post doctors_url, params: { doctor: { name: @doctor.name, phone_number: @doctor.phone_number } }
    end
  ...
  test "should update doctor" do
    patch doctor_url(@doctor), params: { doctor: { name: @doctor.name, phone_number: @doctor.phone_number } }
